...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  {
    id: "prestige_1",
    name: "Kelahiran Kembali",
    desc: "Lakukan Prestige pertama kali",
    emoji: "✨",
    category: "special",
    condition: { stat: "totalPrestiges", value: 1 },
    rewardXp: 100,
    rewardCoins: 500,
    secret: false,
  },
  {
    id: "prestige_3",
    name: "Veteran Prestige",
    desc: "Lakukan Prestige 3 kali",
    emoji: "🌌",
    category: "special",
    condition: { stat: "totalPrestiges", value: 3 },
    rewardXp: 300,
    rewardCoins: 2000,
    secret: false,
  },
  {
    ...
    desc: "Lakukan Prestige 5 kali",
    emoji: "👑",
    category: "special",
    condition: { stat: "totalPrestiges", value: 5 },
    rewardXp: 500,
    rewardCoins: 5000,
    secret: false,
  },
...
export const ACHIEVEMENT_CATEGORIES: Record<string, any> = {
