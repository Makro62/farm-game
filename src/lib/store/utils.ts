...
export const MINING_REGEN_MS: Record<number, number> = GAME_CONSTANTS.MINING.REGEN_MS as Record<number, number>;

export function getMiningRegenMs(mining: any, weatherEffects: any = null) {
...
export function getAnimalProduceTime(animal: any, weatherEffects: any = null) {
...
export function getGrowthMultiplier(state: any) {
...
export function consumeInventoryItem(inventory: any, itemId: any) {
...
export function safeCoins(value: any, fallback: any = 100) {
  const n = Number(value);
  return Number.isFinite(n) ? Math.max(0, Math.floor(n)) : fallback;
}

export function safePositiveNumber(value: any, fallback: any = 0) {
  const n = Number(value);
...
export function checkRecipeIngredients(recipe: any, inventory: any, inventoryByCategory: any) {
...
export function normalizePlot(plot: any, index: any = 0) {
...
export function migrateLegacyWorkers(merged: any) {
